...
namespace DoctorApp.Migrations
{
    ...
    [Migration("20201104064850_new table certififcation")]
    partial class newtablecertififcation
    {
            ...
            modelBuilder.Entity("DoctorApp.Modals.Doctor", b =>
                {
                    b.HasOne("DoctorApp.Modals.Category", "Category")
                        .WithOne("Doctor")
                        .HasForeignKey("DoctorApp.Modals.Doctor", "Category_Id");

                    b.HasOne("DoctorApp.Modals.Specialties", "Specialties")
                        .WithOne("Doctor")
                        .HasForeignKey("DoctorApp.Modals.Doctor", "Speciality_Id");
            ...
            modelBuilder.Entity("DoctorApp.Modals.Transaction", b =>
                {
                    b.HasOne("DoctorApp.Modals.Wallet", "Wallet")
                        .WithOne("Transaction")
                        .HasForeignKey("DoctorApp.Modals.Transaction", "Wallet_Id");
                });
            ...
            modelBuilder.Entity("DoctorApp.Modals.Wallet", b =>
                {
                    b.HasOne("DoctorApp.Modals.Appointment", "Appointment")
                        .WithOne("Wallet")
                        .HasForeignKey("DoctorApp.Modals.Wallet", "Appointment_Id");
                });
